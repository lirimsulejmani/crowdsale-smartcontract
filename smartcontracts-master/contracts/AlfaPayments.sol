...
contract AlfaPayments is Ownable { 
    ...
    function AlfaPayments(address arbitrationAddress_, uint256 arbitrationFee_) public {
    ...
    returns(bool success)
    {
        // TODO: pass escrow to Alfa Arbitration protocol
